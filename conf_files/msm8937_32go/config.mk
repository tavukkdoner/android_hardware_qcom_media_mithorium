CONFIG_PATH := hardware/qcom/media/conf_files/msm8937_32go
...
ifeq (($(TARGET_1G_DDR_RAM), true)
        PRODUCT_COPY_FILES +=\ 
                $(CONFIG_PATH)/media_codecs_vendor_msm8937_32go_1gb.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_vendor.xml 
else
        PRODUCT_COPY_FILES +=\
